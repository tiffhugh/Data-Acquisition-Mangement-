...
# Select only the Skill and DataSource columns
subset_data3 <- data_df %>%
  select(Skill, DataSource)

# Print the final subset data
print(subset_data3)
...
# Merging subset_data and subset_data2
merged_data <- merge(subset_data, subset_data2, by = "Skill", all = TRUE)

# Merging the result with subset_data3
merged_data <- merge(merged_data, subset_data3, by = "Skill", all = TRUE)
